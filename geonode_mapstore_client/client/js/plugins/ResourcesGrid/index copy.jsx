...
import ConnectedCardGrid from './containers/ConnectedCardGrid';
import { getTotalResources, getFacetsItems, getShowFilterForm } from '@js/selectors/search';
import { searchResources, setSearchConfig, getFacetItems, setFilters as setFiltersAction, showFilterForm as showFilterFormAction, loadingResources, updateResources, updateResourcesMetadata } from '@js/actions/gnsearch';
...
import { resourceHasPermission, getResourceStatus, getResourceTypesInfo } from '@js/utils/ResourceUtils';
...
const ResourcesGridPlugin = connect(
    ...
    ], (params, user, totalResources, loading, location, resource, monitoredState, error, facets, filters, showFilterForm, customFilters) => ({
        params,
        user,
        totalResources,
        loading,
