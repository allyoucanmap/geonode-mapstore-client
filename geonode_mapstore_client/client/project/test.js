...
const karmaConfigSingleRunPath = path.join(__dirname, 'config', 'karma.conf.single-run.js');
const karmaConfigContinuousPath = path.join(__dirname, 'config', 'karma.conf.continuous-test.js');
