...
def run_setup_hooks(*args, **kwargs):
    ...
    setattr(settings, "CLIENT_APP_LIST", ["geostory", "dashboard", "app"])
    setattr(
        settings,
        "CLIENT_APP_ALLOWED_PERMS_LIST",
        [{"geostory": allowed_perms}, {"dashboard": allowed_perms}, {"app": allowed_perms}],
    )
    setattr(
        settings,
    ...
    settings.EXTRA_METADATA_SCHEMA = {
        ...
        **{
            ...
            "app": settings.DEFAULT_EXTRA_METADATA_SCHEMA,
        },
    }
